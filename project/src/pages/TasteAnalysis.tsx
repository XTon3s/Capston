...
function AnimatedText({ text, delay = 0, duration = 0.3 }) {
  return (
    <div
  ...
  return (
    <div className="flex items-center justify-center min-h-screen">
      <div className="text-center space-y-8">
        <AnimatedText text="취향분석을 시작하시겠습니까?" />
        {!isAnalyzing && (
          <button
            onClick={handleStartAnalysis}
            className="mt-6 opacity-0 animate-[fadeIn_0.3s_ease-in-out_0.3s_forwards] hover:scale-110 transition-transform"
          >
